...
export class QRPage implements OnInit {
  ...
  userAsignaturacodigo?: asignatura [] = [];
    ...
    if(this.userSeccion){
      ...
      if(this.userHorario){
        ...
        if(this.userAsignatura){
          ...
          const reponse = await lastValueFrom(this.userService.postAsistencia(this.horaActual,this.fechaActual,"Ausente",this.userclase?.id_clase,asignatura.rut_alumno))
          }
        }
      }
    }
